...
void __fastcall TDM::TenrFilterRecord(TDataSet *DataSet, bool &Accept)
{
	...
	if(Finputedit->RG3fsex->ItemIndex==1)Accept=Accept&&Tenrsex->AsString=="ìóæ";
	else if (Finputedit->RG3fsex->ItemIndex==2) Accept=Accept&&Tenrsex->AsString=="æåí";
	if(Finputedit->RG4fdoc->ItemIndex==1)Accept=Accept&&Tenrdoc_edu->AsString=="äèïëîì";
	else if (Finputedit->RG4fdoc->ItemIndex==2) Accept=Accept&&Tenrdoc_edu->AsString=="àòòåñòàò";
...
void __fastcall TDM::TemtFilterRecord(TDataSet *DataSet, bool &Accept)
{
	...
	if(Finputedit->RGfbud_com->ItemIndex==1)Accept=Accept&&Temtbud_com->AsString=="áþäæåò";
	else if (Finputedit->RGfbud_com->ItemIndex==2) Accept=Accept&&Temtbud_com->AsString!="áþäæåò";
